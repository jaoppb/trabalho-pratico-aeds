...
//class Pessoa
Pessoa::Pessoa(unsigned int codigo, double telefone, std::string nome)://implementação do construtor da classe Pessoa
...
const double       Pessoa::getTelefone() const { return this->telefone; }
